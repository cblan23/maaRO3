...
- 255 条机器可读来源，覆盖国服官方、全球官方、Bilibili、YouTube、Twitch、巴哈、4Gamers、PChome、PTT 等；23 条 Twitch 分类内有效 VOD 与 3 条分类外／混合 RO3 长直播已完成故事板、聊天定位和重点秒级回抽，另有 16 条 Twitch 非 RO3 误命中完成 3,200 张全程稀疏帧排除；Twitch 全时段目录的 30 条 Clip（8 条 TEST-B＋22 条旧构建）均已全片复核，巴哈 RO3 板 74 个主题已完成目录盘点与 TEST-B 时段定向扫描；新增七条 Bilibili 差集录像完成 1,011 张全程故事板／时间线审阅，多批 YouTube 长直播因公开访问验证仍待审帧；
- 26 条官方／准官方来源的逐条事实和待复核项；
- 32 份视频 Manifest／142 张视频关键帧和 1 份静态 Manifest／1 张一手原图，覆盖日常、挂机、生活、宠物、精炼、公会、精灵之塔、异常、连接与复活反例，带 URL、BVID／VOD／Clip、时间戳、限制和 SHA-256；新增 G-STAR 2024 Boss 场“原地复活”四帧链，严格隔离旧构建；
