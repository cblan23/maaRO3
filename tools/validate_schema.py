...
# Windows PowerShell may expose a legacy GBK stdout even when every project
# file is UTF-8.  The upstream validator prints Unicode status symbols, so make
# its console output deterministic instead of crashing after a valid result.
